...
namespace route_following_plugin
{
    ...
    {        
        ...
        {
            ROS_ERROR_STREAM("Cannot find current position is not on the shortest path! Returning empty maneuver");
            return true;
        }
        ROS_ERROR_STREAM("curr_lat id:" << shortest_path[last_lanelet_index].id());
